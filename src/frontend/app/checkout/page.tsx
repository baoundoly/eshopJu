...
import { createOrder, generateWhatsAppLink } from '@/lib/api';
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
                ...
                <div className="space-y-3">
                  {PAYMENTS.map((pm) => (
                    <label key={pm.value} className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${paymentMethod === pm.value ? 'border-rose-500 bg-rose-500/10' : 'border-gray-700 hover:border-gray-600'}`}>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800 sticky top-20">
                ...
                <div className="space-y-2 text-sm border-t border-gray-800 pt-4">
                  ...
                  <div className="flex justify-between text-gray-400">
                    <span>Delivery</span><span className="text-white">৳{DELIVERY}</span>
                  </div>
